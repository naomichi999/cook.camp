...
ActiveRecord::Schema.define(version: 2019_10_24_172016) do
  ...
  create_table "sections", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["section_title"], name: "index_sections_on_section_title", unique: true
  end
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_title"], name: "index_tasks_on_task_title", unique: true
  end
